module github.com/zeddo123/mlsolid

go 1.25.0

require (
	buf.build/gen/go/zeddo123/mlsolid/grpc/go v1.6.1-20251120143240-31fab483c762.1
	buf.build/gen/go/zeddo123/mlsolid/protocolbuffers/go v1.36.11-20251120143240-31fab483c762.1
