...
require (
	buf.build/gen/go/zeddo123/mlsolid/grpc/go v1.6.1-20260417233225-968b2c0fbef3.1
	buf.build/gen/go/zeddo123/mlsolid/protocolbuffers/go v1.36.11-20260417233225-968b2c0fbef3.1
