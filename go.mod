...
require (
	buf.build/gen/go/zeddo123/mlsolid/grpc/go v1.6.2-20260531004301-d3d5145f26e4.1
	buf.build/gen/go/zeddo123/mlsolid/protocolbuffers/go v1.36.11-20260531004301-d3d5145f26e4.1
